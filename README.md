...
- To experiment with issues that run on server-side environments: node.js environment, available at http://nodejs.org/, and/or io.js, available at https://iojs.org/ . We run experiments on node v0.10.37 and v0.12 and io.js 3.2.0. To switch between different versions of node.js and io.js, we use nvm, available at https://www.npmjs.com/package/nvm.
