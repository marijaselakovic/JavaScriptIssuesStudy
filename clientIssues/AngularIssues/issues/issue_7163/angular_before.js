/**
 * @license AngularJS v1.3.17-local+sha.8d0cb30
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.17-local+sha.8d0cb30/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.17-local+sha.8d0cb30',    // all of these placeholder strings will be replaced by grunt's
