/**
 * @license AngularJS v1.3.18-local+sha.3f13059
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.3f13059/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.3f13059',    // all of these placeholder strings will be replaced by grunt's
