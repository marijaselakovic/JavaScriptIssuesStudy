/**
 * @license AngularJS v1.3.18-local+sha.ffb6f9a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.ffb6f9a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.ffb6f9a',    // all of these placeholder strings will be replaced by grunt's
