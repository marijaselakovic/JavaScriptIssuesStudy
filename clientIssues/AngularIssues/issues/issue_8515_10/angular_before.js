/**
 * @license AngularJS v1.3.18-local+sha.7c5a1b0
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.7c5a1b0/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.7c5a1b0',    // all of these placeholder strings will be replaced by grunt's
