/**
 * @license AngularJS v1.3.18-local+sha.b52511c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.b52511c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.b52511c',    // all of these placeholder strings will be replaced by grunt's
