/**
 * @license AngularJS v1.3.18-local+sha.bb5bc96
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.bb5bc96/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.bb5bc96',    // all of these placeholder strings will be replaced by grunt's
