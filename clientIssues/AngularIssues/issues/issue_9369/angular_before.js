/**
 * @license AngularJS v1.3.18-local+sha.b1ee538
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.b1ee538/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.b1ee538',    // all of these placeholder strings will be replaced by grunt's
