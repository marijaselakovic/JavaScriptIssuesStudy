/**
 * @license AngularJS v1.2.5-043190f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-043190f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-043190f',    // all of these placeholder strings will be replaced by grunt's
