/**
 * @license AngularJS v1.3.18-local+sha.dccd43b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.dccd43b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.dccd43b',    // all of these placeholder strings will be replaced by grunt's
...
forEach({
  ...
  triggerHandler: function(element, eventName, eventData) {
    ...
    var eventFnsCopy = shallowCopy(eventFns || []);
