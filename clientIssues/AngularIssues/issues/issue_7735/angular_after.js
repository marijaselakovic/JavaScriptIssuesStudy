/**
 * @license AngularJS v1.2.9-build.local+sha.004e77e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.9-build.local+sha.004e77e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.9-build.local+sha.004e77e',    // all of these placeholder strings will be replaced by grunt's
