/**
 * @license AngularJS v1.3.18-local+sha.10c6ec5
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.10c6ec5/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.10c6ec5',    // all of these placeholder strings will be replaced by grunt's
