/**
 * @license AngularJS v1.2.6-build.local+sha.a0e385f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.a0e385f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.a0e385f',    // all of these placeholder strings will be replaced by grunt's
