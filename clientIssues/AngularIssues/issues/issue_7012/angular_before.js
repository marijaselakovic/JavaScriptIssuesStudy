/**
 * @license AngularJS v1.3.17-local+sha.531a8de
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.17-local+sha.531a8de/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.17-local+sha.531a8de',    // all of these placeholder strings will be replaced by grunt's
