/**
 * @license AngularJS v1.3.17-local+sha.37790e9
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.17-local+sha.37790e9/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.17-local+sha.37790e9',    // all of these placeholder strings will be replaced by grunt's
