/**
 * @license AngularJS v1.3.18-local+sha.6e7fbe7
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.6e7fbe7/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.6e7fbe7',    // all of these placeholder strings will be replaced by grunt's
