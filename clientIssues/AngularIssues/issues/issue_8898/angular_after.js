/**
 * @license AngularJS v1.3.18-local+sha.db9d40a
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.db9d40a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.db9d40a',    // all of these placeholder strings will be replaced by grunt's
