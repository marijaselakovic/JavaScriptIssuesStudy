/**
 * @license AngularJS v1.3.18-local+sha.e43541f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.e43541f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.e43541f',    // all of these placeholder strings will be replaced by grunt's
