/**
 * @license AngularJS v1.3.18-local+sha.7041d5b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.7041d5b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.7041d5b',    // all of these placeholder strings will be replaced by grunt's
