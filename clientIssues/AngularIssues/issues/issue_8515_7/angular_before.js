/**
 * @license AngularJS v1.3.18-local+sha.a7e5d25
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.a7e5d25/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.a7e5d25',    // all of these placeholder strings will be replaced by grunt's
