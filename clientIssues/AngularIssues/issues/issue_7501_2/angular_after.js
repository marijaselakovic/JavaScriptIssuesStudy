/**
 * @license AngularJS v1.3.17-local+sha.b6fd9eb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.17-local+sha.b6fd9eb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.17-local+sha.b6fd9eb',    // all of these placeholder strings will be replaced by grunt's
    ...
    function $interpolate(text, mustHaveExpression, trustedContext, allOrNothing) {
      ...
      if (!mustHaveExpression || hasInterpolation) {
        ...
        var stringify = function (value) {
          if (isUndefined(value)||value == null) { // null || undefined
            return '';
          }
          switch (typeof value) {
            case 'string': {
