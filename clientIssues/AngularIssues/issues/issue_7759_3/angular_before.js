/**
 * @license AngularJS v1.3.18-local+sha.8364e21
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.8364e21/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.8364e21',    // all of these placeholder strings will be replaced by grunt's
