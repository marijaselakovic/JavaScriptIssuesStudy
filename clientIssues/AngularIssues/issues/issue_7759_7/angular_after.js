/**
 * @license AngularJS v1.3.18-local+sha.9db0cdf
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.18-local+sha.9db0cdf/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.18-local+sha.9db0cdf',    // all of these placeholder strings will be replaced by grunt's
